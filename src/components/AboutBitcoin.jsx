...
const AboutBitcoin = () => {
  return (
    <div className='mx-11 mt-3 w-881 mb-10 bg-white border border-gray-300 rounded-lg p-2 px-3 pt-5 m-2 pb-5'>
      ...
      <p className='w-830 mt-2 text-gray-500 text-base font-medium'>
      ...
      <p className='w-830 mt-3 text-base font-medium'>
      ...
      <p className='w-830 mt-3 py-1 text-base font-medium'>
